...
<head>
  ...
  <!-- Core CSS -->
  <link rel="stylesheet" href="<?= site_url('assets/sneat') ?>/assets/vendor/css/core.css" class="sneat-customizer-core-css" />
  <link rel="stylesheet" href="<?= site_url('assets/sneat') ?>/assets/vendor/css/theme-default.css" class="sneat-customizer-theme-css" />
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="<?= base_url() ?>" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">PortalSejarah</span>
          </a>
        ...
        <footer class="content-footer footer bg-footer-theme">
          <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
            <div class="mb-2 mb-md-0">
              ...
              , made with ❤️ by
              <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">Rafael26</a>
            </div>
          </div>
        </footer>
        <!-- / Footer -->
...
<script src="https://cdn.tiny.cloud/1/sumwnjzd1ax9tegpjemmz8gdb3ipov79vse7cw5pf3bu0m4d/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
